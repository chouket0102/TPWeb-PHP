...
<html>
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <a href="./FirstFighter.php?name=Lockpin" style="text-decoration: none; color: inherit;" >
                <div>Lockpin</div>
            ...
            <div class="col alert alert-secondary">
            <a href="./FirstFighter.php?name=Arceus" style="text-decoration: none; color: inherit;" >
                <div>Arceus</div>
        ...
        <div class="row">
        <div class="col alert alert-secondary">
            <a href="./FirstFighter.php?name=Charizard" style="text-decoration: none; color: inherit;" >
                <div>Charizard</div>
                <img src="./images/charizard.jpg" class="image">
            </a>
            </div>
            <div class="col alert alert-secondary">
            <a href="./FirstFighter.php?name=Blastoise" style="text-decoration: none; color: inherit;" >
                <div>Blastoise</div>
                <img src="./images/blastoise.jpg" class="image">
            </a>
            </div>
            <div class="col alert alert-secondary">
            <a href="./FirstFighter.php?name=Venusaur" style="text-decoration: none; color: inherit;" >
                <div>Venusaur</div>
